...
## 🛏️ Hotel
- **Auberge de l’Étable (Accous)**
	- 💶 ~65–80€
	- 📍 Aldeia pequena
	- ✅ Ambiente local, muito calma
- **Gîte d’Étape d’Accous**
	- 💶 Opção mais económica ~30-40€
	- ✅ Limpo, simples, muito usado por caminhantes/motards
- **Hotel Bar du Commerce (Bedous)**
	- 💶 ~70–85€
	- 📍 Clássico alpino
	- ✅ Estacionamento fácil
- **Hotel Transhumance & Cie (Accous)**
	- Pequeno, local, ambiente de montanha
- **Auberge des Isards (Etsaut)**
	- Clássico alpino
...
* Pistas abertas, prados alpinos
* Paisagem ampla e calma
* Perfeito para big trail carregada

- `gpx/offroad2_plateau_du_benou.gpx`
